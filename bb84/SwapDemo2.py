...
for i in range(b):
    #alice_angles_txt.append(str(2*i)+"pi/"+str(b))
...
print("Swap test with correct signature")
print(checkSign(create_sign(alice_sign, alice_angles_val), create_sign(alice_sign, alice_angles_val)))


print("Swap test with a forged signature")
print(checkSign(create_sign(alice_sign, alice_angles_val), create_sign(fakeSign, fake_angles_val)))
