...
print("Alice's Signature (Before Encoding)")
print(alice_sign)
print("Swap test with correct signature")
print(checkSign(create_sign(alice_sign), create_sign(alice_sign)))
print()

print("Forged Signature (Before Encoding)")
print(fakeSign)
print("Swap test with a forged signature")
print(checkSign(create_sign(alice_sign), create_sign(fakeSign)))
## Step 2
