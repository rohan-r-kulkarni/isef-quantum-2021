...
plt.scatter(next_narr(n_vals,0), data[n_vals[0]], c='r')
plt.scatter(next_narr(n_vals,1), data[n_vals[1]], c='r')
plt.scatter(next_narr(n_vals,2), data[n_vals[2]], c='r')
plt.scatter(next_narr(n_vals,3), data[n_vals[3]], c='r')
plt.scatter(next_narr(n_vals,4), data[n_vals[4]], c='r')
plt.scatter(next_narr(n_vals,5), data[n_vals[5]], c='r')
plt.scatter(next_narr(n_vals,6), data[n_vals[6]], c='r')
run = plt.scatter(next_narr(n_vals,7), data[n_vals[7]], c='r')
...
# ax.legend(labels = ('Perfect Retention', '50% Retention', 'Inefficiency', 'Averages', 'Trial Result'), loc = 'upper left') # legend placed at lower right
ax.set_title("QKD Retention: Qubits Retained vs. N")
ax.set_xlabel('N (Total Number of Qubits)')
ax.set_ylabel('Retention (Number of Qubits)')
fig.savefig("./retention_graph.png")
plt.show()
